...
Dokument opisuje wszystkie znane ograniczenia i limity KSeF API v2.1/v2.2, ich wpływ na działanie aplikacji oraz zastosowane obejścia.
...
**Wersja API:** v2.1/v2.2 (produkcja od 2026-02-26)
